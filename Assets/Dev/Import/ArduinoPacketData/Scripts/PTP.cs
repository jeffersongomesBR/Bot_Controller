...
public class PTP : MonoBehaviour {
    ...
    // Variables
    // 
    [Tooltip("Allows key events to be displayed in the editor console")]
    public bool ShowDebugLog = true;

    bool AllowConnect = false;
    [Tooltip("Allows connection to the port immediately after startup.")]
    public bool ConnectOnStart = true;
    [Tooltip("Allows reconnection when a connection is lost after a period of time.")]
    public bool AutoReconnect = true;
    [Tooltip("Waiting period before reconnecting. The period is set in milliseconds.")]
    public int ReconnectAfterMs = 5000;
    SerialPort serialPort = new SerialPort();
    [Tooltip("Port Name for operation.")]
    ...
    // Мониторинг
    [Tooltip("Number of bytes received.")]
    public ulong BytesReceived = 0;
    [Tooltip("The number of packets received.")]
    public ulong PacketsReceived = 0;

    /// <summary>
    /// Disconnect from the port.
    /// </summary>
    /// <param name="disableAutoReConnect">disables reconnection in case of loss of connection.</param>
    ...
    /// </summary>
    /// <param name="enableAutoReConnect">allows reconnection in case of loss of connection.</param>
    ...
    /// </summary>
    /// <param name="enableAutoReConnect">allows reconnection in case of loss of connection</param>
    /// <returns>Returns True on successful connection.</returns>
    ...
    // Transfer Data
    /// <summary>
    /// Data transfer packed in the body of an object of class DATA.
    /// </summary>
    /// <param name="d"></param>
